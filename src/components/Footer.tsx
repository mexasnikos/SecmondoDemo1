        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="/regular-stay" className="text-gray-600 hover:text-indigo-600 transition-colors">
                  Regular Single Trip
                </a>
              </li>
              <li>
                <a href="/annual-multi-trip" className="text-gray-600 hover:text-indigo-600 transition-colors">
                  Annual Multi-Trip
                </a>
              </li>
              <li>
                <a href="/comprehensive" className="text-gray-600 hover:text-indigo-600 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="/partners" className="text-gray-600 hover:text-indigo-600 transition-colors">
                  Partners
                </a>
              </li>
              <li>
                <a href="/affiliates" className="text-gray-600 hover:text-indigo-600 transition-colors">
                  Affiliates
                </a>
              </li>
            </ul>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-8">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 pt-8 border-t border-gray-200">
            <div className="flex items-center gap-2">
              <h2 className="text-2xl font-bold text-indigo-600">Secmondo</h2>
