...
const LongStayTrip: React.FC<LongStayTripProps> = ({ onNavigate }) => {
            ...
            <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
              ...
              <section className="mt-24 max-w-7xl mx-auto px-6 lg:px-8">
                <div className="text-center mb-12">
                  <h2 className="text-4xl font-bold text-gray-900 mb-4">Long Stay Trip Coverage</h2>
                  <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                    Extended protection for long-term adventures and working holidays
                  </p>
                </div>
                  ...
                  {[
                    {
                      ...
                      description: 'Up to €10,000,000 medical expenses coverage for extended trips up to 15 months.'
                    },
                    {
                      title: 'Business Equipment',
                      description: 'Coverage up to €5,000 for laptops, cameras, and other business equipment essential for digital nomads.'
                    },
                    {
                      title: 'Study Materials',
                      description: 'Protection for study materials and educational equipment during gap years and educational trips.'
                    },
                    {
                      title: 'Temporary Accommodation',
                      description: 'Coverage for emergency accommodation if your primary lodging becomes uninhabitable.'
                    },
                    {
                      title: 'Personal Liability',
                      description: 'Enhanced personal liability coverage up to €5,000,000 for long-term stays.'
                    },
                    {
                      title: 'Worldwide Coverage',
                      description: 'Travel anywhere in the world for up to 15 months with 24/7 emergency assistance.'
                    }
                  ].map((coverage, index) => (
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  <div className="bg-white rounded-2xl shadow-lg p-8">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      "Perfect for my year-long working holiday in Australia! The long stay policy covered my laptop when it broke, and the claims process was smooth."
                    </p>
                  </div>
                  <div className="bg-white rounded-2xl shadow-lg p-8">
                    <div className="flex items-center mb-4">
                      ...
                      <div>
                        <h4 className="font-bold text-gray-900">Lucy Martinez</h4>
                        <p className="text-sm text-gray-600">Gap Year Traveler</p>
                      </div>
                    </div>
                    <div className="text-yellow-400 text-xl mb-3">⭐⭐⭐⭐⭐</div>
                    <p className="text-gray-700 leading-relaxed">
                      "Excellent coverage for my gap year travels across Asia. Had a medical emergency in Vietnam and Secmondo took care of everything!"
                    </p>
                  </div>
                  <div className="bg-white rounded-2xl shadow-lg p-8">
                    <div className="flex items-center mb-4">
                      ...
                      <div>
                        <h4 className="font-bold text-gray-900">Tom Brown</h4>
                        <p className="text-sm text-gray-600">Working Traveler</p>
                      </div>
                    </div>
                    <div className="text-yellow-400 text-xl mb-3">⭐⭐⭐⭐⭐</div>
                    <p className="text-gray-700 leading-relaxed">
                      "Great value for long-term travel. The business equipment coverage gave me peace of mind while working remotely across Europe."
                    </p>
                  </div>
                </div>
              </section>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gray-900 text-white py-20 rounded-[3rem] mx-4 sm:mx-6 lg:mx-8 mb-8">
